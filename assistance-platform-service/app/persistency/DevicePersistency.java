...
public class DevicePersistency {
     ...
     * specification.
     *
     * @param deviceSpec The Specification of the device
    ...
    private static Device convertResultArrayToDevice(Object[] array) {
        ...
        long lastUsage = timestamp == null ? 0L : timestamp.toInstant()
                .getEpochSecond();
