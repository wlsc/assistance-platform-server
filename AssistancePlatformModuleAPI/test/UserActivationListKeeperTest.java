...
public class UserActivationListKeeperTest {
  ...
  public void moduleSepratationTest() throws Exception {
    ...
    UserActivationListKeeper keeperToTest1 =
        new UserActivationListKeeper("test1", dummyMs, new DoNothingUserActivationPuller());
    UserActivationListKeeper keeperToTest2 =
        new UserActivationListKeeper("test2", dummyMs, new DoNothingUserActivationPuller());

    Channel<UserRegistrationInformationEvent> regInfoChannel =
        dummyMs.channel(UserRegistrationInformationEvent.class);
  ...
  public void initialPullTest() throws Exception {
    ...
    UserActivationListKeeper keeperToTest1 = new UserActivationListKeeper("test1", dummyMs, cli);
