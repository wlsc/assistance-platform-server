...
public abstract class Module {
  ...
  /**
   * This method gets called before all services are set up and events are registered. This is the
   * place to register for events.
   */
  protected abstract void doBeforeStartup();

  /**
   * This method gets called imediately after all services are set up and events are registered.
   * Implement this for one-time initialization routines like pulling latest data.
   */
