...
public interface ISparkService {
	...
	/**
	 * Creates and returns a event receiver stream (streams events from the messaging system [e.g. ActiveMQ]).
	 * Note that this can be prefiltered (e.g. user registration filtered)
	 * @param sc
	 * @param eventType
	 * @return
	 */
