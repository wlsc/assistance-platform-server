...
public class MessagingServiceReceiver<T> extends Receiver<T> {
  ...
  /**
   * Creates the messaging service receiver for Spark streaming purposes. Note that the
   * messagingServiceSupplier is needed for per-spark-worker-node construction.
   * 
   * @param eventType
   * @param messagingServiceSupplier
   */
  public MessagingServiceReceiver(String usingModuleId, String platformUrlAndPort,
      Class<T> eventType) {
