...
public class ModuleBundleClientActionRunnerProxy implements IClientActionRunner {
	...
	public ModuleBundleClientActionRunnerProxy(ModuleBundle bundle, IClientActionRunner actionRunner) {
	...
	public void sendDataAndMessage(long userId, long[] deviceIds, String title,
			String message, String data, Consumer<Void> onSuccess,
			Consumer<Void> onError) {
		actionRunner.sendDataAndMessage(userId, deviceIds, proxiedNotificationTitle(title), message, data, onSuccess, onError);
	}
