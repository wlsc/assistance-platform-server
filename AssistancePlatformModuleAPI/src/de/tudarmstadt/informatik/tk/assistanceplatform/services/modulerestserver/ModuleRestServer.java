...
/**
 * This class provides the basic structure for the module-owned rest server for serving basic
 * requests from the platform. On top servlets can be set for custom endpoints.
 * 
 * @author bjeutter
 *
 */
public class ModuleRestServer {
  ...
  private void bindStandardServletsToContext() {
    Collection<MappedServlet> standardServlets =
        new RequiredRestEndpointsFactory().getRequiredServlets();
