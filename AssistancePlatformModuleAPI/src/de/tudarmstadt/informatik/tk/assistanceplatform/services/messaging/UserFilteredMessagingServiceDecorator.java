...
/**
 * This class is responsible for filtering messages (/ events) via a user activation list. Only
 * events of users that are on the activation list are passed through by this class.
 */
public class UserFilteredMessagingServiceDecorator extends MessagingService {
  ...
  public UserFilteredMessagingServiceDecorator(MessagingService serviceToFilter,
      IUserActivationChecker activationChecker) {
